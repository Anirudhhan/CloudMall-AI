...
import { ShoppingCart, Heart, Star, Truck, Shield, ArrowLeft, Plus, Minus, Check } from 'lucide-react';
...
export default function ProductDetailPage() {
  ...
  // Mock images (in real app, you'd have multiple product images)
  const images = [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <button className="p-4 bg-white border-2 border-slate-200 rounded-xl hover:border-pink-300 hover:bg-pink-50 transition-all">
